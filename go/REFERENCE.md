# SxpVpn Golang SDK Reference

Complete API reference for the SxpVpn Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *SxpVpnSDK`
...
#### `Server(data map[string]any) SxpVpnEntity`
