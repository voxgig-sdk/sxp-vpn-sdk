...
from sxpvpn_sdk.utility import register

# Load features
from sxpvpn_sdk.feature.base_feature import SxpVpnBaseFeature
from sxpvpn_sdk.features import _has_feature, _make_feature
...
class SxpVpnSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = SxpVpnUtility()
        self._utility = utility

        from sxpvpn_sdk.config import shared_config
    ...
    def get_utility(self):
        return SxpVpnUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SxpVpnSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Server(self, data=None) -> "ServerEntity":
        ...
        from sxpvpn_sdk.entity.server_entity import ServerEntity
        return ServerEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "SxpVpnSDK":
        if sdkopts is None:
            sdkopts = {}
