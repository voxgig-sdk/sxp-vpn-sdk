...
from sxpvpn_sdk.core.control import SxpVpnControl
...
from sxpvpn_sdk.core.helpers import get_ctx_prop, to_map
...
class SxpVpnContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, SxpVpnResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return SxpVpnError(code, msg, self)
