# SxpVpn SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SxpVpnSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SxpVpnSDK(...) and SxpVpnSDK.test(...) become
#      SxpVpnSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "sxpvpn_sdk"
_SDK_CLASS = "SxpVpnSDK"
