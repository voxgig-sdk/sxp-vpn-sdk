...
func registerSDKWords(r *eng.Registry, client *sdk.SxpVpnSDK) {
...
func runOp(client *sdk.SxpVpnSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
