...
|---|---|---|
| `ts/` | @voxgig-sdk/sxp-vpn-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/sxp-vpn-sdk \
      --repository voxgig-sdk/sxp-vpn-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/sxp-vpn-sdk` shows it, and
`npm trust revoke @voxgig-sdk/sxp-vpn-sdk --id=<id>` removes it.
