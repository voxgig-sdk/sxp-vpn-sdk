...
class SxpVpnCacheFeature extends SxpVpnBaseFeature
{
    ...
    private function _through(SxpVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
