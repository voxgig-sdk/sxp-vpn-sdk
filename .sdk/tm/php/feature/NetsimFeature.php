...
class SxpVpnNetsimFeature extends SxpVpnBaseFeature
{
    ...
    private function _simulate(SxpVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SxpVpnContext $ctx, array $applied): void
    {
        $client = $this->client;
