...
class SxpVpnTimeoutFeature extends SxpVpnBaseFeature
{
    ...
    private function _with_timeout(SxpVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SxpVpnContext $_ctx, float $ms): void
    {
        $client = $this->client;
