...
// SxpVpn SDK clienttrack feature
...
class SxpVpnClienttrackFeature extends SxpVpnBaseFeature
{
    ...
    public function PostConstruct(SxpVpnContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SxpVpn-SDK';
