...
class SxpVpnFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SxpVpnSDK/1.0)';
    ...
    public static function call(SxpVpnContext $ctx, string $fullurl, array $fetchdef): array
    {
