...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = SxpVpnOmni.make_runner(TEST_JSON_FILE, SxpVpnSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : SxpVpnOmni.errify(err)
    end
