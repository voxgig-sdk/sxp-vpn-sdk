...
from projectname_sdk import SxpVpnSDK
from projectname_sdk.core.spec import SxpVpnSpec
from projectname_sdk.core.result import SxpVpnResult
from projectname_sdk.core.response import SxpVpnResponse
from projectname_sdk.core.operation import SxpVpnOperation
from projectname_sdk.core.error import SxpVpnError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import SxpVpnBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = SxpVpnSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = SxpVpnSDK.test(None, None)
        ...
        class TestInitFeature(SxpVpnBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(SxpVpnBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = SxpVpnSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = SxpVpnSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = SxpVpnSDK.test(None, setup_opts)
