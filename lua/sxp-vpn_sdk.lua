...
SxpVpnSDK._make_feature = _make_feature


function SxpVpnSDK.new(options)
  local self = setmetatable({}, SxpVpnSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function SxpVpnSDK:options_map()
...
function SxpVpnSDK:get_utility()
  return Utility.copy(self._utility)
end


function SxpVpnSDK:get_root_ctx()
  return self._rootctx
end


function SxpVpnSDK:prepare(fetchargs)
...
function SxpVpnSDK:direct(fetchargs)
...
-- by passing it.
function SxpVpnSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function SxpVpnSDK:graphql(query, variables, ctrl)
...
function SxpVpnSDK:Server(data)
...
function SxpVpnSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = SxpVpnSDK.new(sdkopts)
  sdk.mode = "test"
