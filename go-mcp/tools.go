...
func registerTools(server *mcp.Server, client *sdk.SxpVpnSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "sxp-vpn_list",
		Description: "List records from SxpVpn. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "sxp-vpn_load",
		Description: "Load a single record from SxpVpn. " +
...
func runOp(client *sdk.SxpVpnSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SxpVpnSDK, name string) (sdk.SxpVpnEntity, error) {
