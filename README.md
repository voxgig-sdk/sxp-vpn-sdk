...
SXP VPN API client, generated from the OpenAPI spec.

The SXP VPN API provides a mobile solution for secure and private internet access.

Learn more about SXP VPN API at [github.com/l0v3m0n3y/sxpvpn](https://github.com/l0v3m0n3y/sxpvpn).

This is an unofficial SDK for the SXP VPN public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
```bash
cd go-mcp && go build -o sxp-vpn-mcp .
```
...
```json
{
  "mcpServers": {
    "sxp-vpn": {
      "command": "/abs/path/to/sxp-vpn-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **Server** | The Server entity (list). | `/api1.php` |
...
```go
import sdk "github.com/voxgig-sdk/sxp-vpn-sdk/go"
...
- Upstream API: [https://github.com/l0v3m0n3y/sxpvpn](https://github.com/l0v3m0n3y/sxpvpn)
...
Generated from the SXP VPN API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
