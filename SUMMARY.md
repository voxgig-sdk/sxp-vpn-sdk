...
Results: Successfully retrieved the list of VPN servers.
...
| --- | --- | --- | --- |
| Server | `list` | `GET /api1.php` | See reference |

## Connect to the API

- Production server: `https://adminvpn.s-xprem.com/sxpVPN/api`
...
- `sxp-vpn_list`: List records for an entity. Supported entities: `server`.
- `sxp-vpn_load`: Load one record for an entity. No active entity supports this operation.
