# SxpVpn TypeScript SDK



The TypeScript SDK for the SxpVpn API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/sxp-vpn-sdk/releases](https://github.com/voxgig-sdk/sxp-vpn-sdk/releases)
...
| `tester(testopts?, sdkopts?)` | `SxpVpnSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `SxpVpnSDK.test(testopts?, sdkopts?)` | `SxpVpnSDK` | Create a test-mode client. |
...
| `client` | `client(): SxpVpnSDK` | Return the parent SDK client. |
