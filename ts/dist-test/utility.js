...
function envOverride(m) {
    if ('TRUE' === process.env.SXP_VPN_TEST_LIVE ||
        'TRUE' === process.env.SXP_VPN_TEST_OVERRIDE) {
    ...
    m.SXP_VPN_TEST_EXPLAIN = process.env.SXP_VPN_TEST_EXPLAIN || m.SXP_VPN_TEST_EXPLAIN;
    return m;
}
