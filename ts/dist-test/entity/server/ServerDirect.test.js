...
(0, node_test_1.describe)('ServerDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('SXP_VPN_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.SxpVpnSDK({
...
function liveScenariosActive() { return false && process.env.SXP_VPN_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SxpVpnSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SXP_VPN_TEST_SERVER_ENTID'];
    ...
    const client = new __1.SxpVpnSDK({
        base: 'http://localhost:8080',
