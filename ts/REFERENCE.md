# SxpVpn TypeScript SDK Reference

Complete API reference for the SxpVpn TypeScript SDK.
...
#### `SxpVpnSDK.test(testopts?, sdkopts?)`
...
**Returns:** `SxpVpnSDK` instance in test mode.
...
Return the parent `SxpVpnSDK` instance.
