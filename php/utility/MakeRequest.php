...
// SxpVpn SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class SxpVpnMakeRequest
{
    public static function call(SxpVpnContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new SxpVpnResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new SxpVpnResponse($fetched);
        } else {
