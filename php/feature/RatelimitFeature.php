...
class SxpVpnRatelimitFeature extends SxpVpnBaseFeature
{
    ...
    private function _acquire(SxpVpnContext $ctx): void
    {
    ...
    private function _track(SxpVpnContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
