...
class SxpVpnProxyFeature extends SxpVpnBaseFeature
{
    ...
    public function init(SxpVpnContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SxpVpnContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
