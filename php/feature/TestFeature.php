...
// SxpVpn SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class SxpVpnTestFeature extends SxpVpnBaseFeature
{
    ...
    public function init(SxpVpnContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (SxpVpnContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (SxpVpnContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(SxpVpnContext $ctx, $op, $args): array
    {
