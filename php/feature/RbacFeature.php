...
class SxpVpnRbacFeature extends SxpVpnBaseFeature
{
    ...
    private function _required(SxpVpnContext $ctx): ?string
    {
    ...
    private function _reject(SxpVpnContext $ctx, string $required): void
    {
    ...
    private function _track(SxpVpnContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
