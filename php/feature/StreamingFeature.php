...
class SxpVpnStreamingFeature extends SxpVpnBaseFeature
{
    ...
    private function _iterate(SxpVpnResult $result): \Generator
    {
    ...
    private function _streamable(SxpVpnContext $ctx): bool
    {
