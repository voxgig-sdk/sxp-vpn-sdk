...
// SxpVpn SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SxpVpnOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SxpVpnOmni::structfix($now, Struct::undef()))
                        !== json_encode(SxpVpnOmni::structfix($val, Struct::undef()))) {
