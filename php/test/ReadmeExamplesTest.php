...
// SxpVpn SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SxpVpnSDK::test)
...
{
    private const SDK_CLASS = 'SxpVpnSDK';
    ...
    private const SDK_BASE = 'sxpvpn_sdk';
